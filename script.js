...
function paintAurora(){
  const isDark = document.body.classList.contains("dark-mode");
  if (!isDark) return; // aurora only at night for best look
  ...
  for (let b = 0; b < bands; b++){
    ...
    // top aurora edge as sine-like curve
    ...
    // gentle blur/glow imitation via overlay pass
...
// Start in dark mode by default unless user chose light
